    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL_1:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/NewGroup4Movies for support")
                sys.exit()
        ...
        if FORCE_SUB_CHANNEL_3:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/NeonGhost_Networks for support")
                sys.exit()
...
░╚════╝░░╚════╝░╚═════╝░╚════╝░
    ...
    async def stop(self, *args):
        await super().stop()
        self.LOGGER(__name__).info("Bot stopped t.me/NeonGhost_Networks .")
